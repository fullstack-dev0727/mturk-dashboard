      ...
      <Suspense fallback={<div class="record-preview">Loading records...</div>}>
        ...
        <Modal centered size="2xl" closeOnOverlayClick={true} opened={modalShow()} onClose={onStop}>
          ...
          <ModalContent>
            ...
            <ModalBody>
              <video controls class='border-2 bg-white border-black-400 dark:text-black-400 hover:bg-black-100 dark:hover:bg-black-700 focus:outline-none  dark:focus:ring-black-700 dark:bg-slate-800 rounded-lg' id='modal-video' poster="./poster.png"></video>
